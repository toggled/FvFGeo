...
##############################
## GNetFVnewGraphSAGE CLASS ##
##############################
#GNetFVnewGraphSAGE, with persistent node_attr and edge_attr
class GNetFVnewGraphSAGE(nn.Module):
    def __init__(self, hparams, encoder, decoder):
        super(GNetFVnewGraphSAGE, self).__init__()
